...
export default function RewardsTab({
  ...
  const filtered = useMemo(() => {
    ...
    return list.filter((r: any) => {
      ...
      if (sourceFilter !== "all" && (r.source || "admin_issued") !== sourceFilter) return false;
  ...
  }, [rewards, typeFilter, statusFilter, reasonFilter, sourceFilter, search, hideDeleted]);
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-3">
          ...
          <Select value={sourceFilter} onValueChange={setSourceFilter}>
            ...
            <SelectContent>
              ...
              <SelectItem value="admin_issued">Admin Issued</SelectItem>
              <SelectItem value="points_exchange">Points Exchange</SelectItem>
