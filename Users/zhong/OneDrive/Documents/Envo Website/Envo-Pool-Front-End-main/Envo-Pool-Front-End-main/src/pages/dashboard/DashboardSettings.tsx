              ...
              <>
                ...
                {otpSent && waLink && (
                  <a
                    ...
                    className="flex items-center justify-center gap-2 w-full rounded-md bg-green-600 hover:bg-green-700 text-white py-2 px-4 text-sm font-medium transition-colors mt-2"
                  >
